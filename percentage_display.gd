extends CanvasLayer
@onready var player_one: Label = $MarginContainer/HBoxContainer/VBoxContainer2/PlayerOne
@onready var player_two: Label = $MarginContainer/HBoxContainer/VBoxContainer/PlayerTwo
